...
class QubPixmapManager :
    ...
    def __init__(self,allow2skip = True) :
        self.__idle = QubPixmapManager._Idle(allow2skip)
    ...
    def plug(self,aQubPlugPixmapManager2Pixmap) :
        self.__idle.plug(aQubPlugPixmapManager2Pixmap)
...
if __name__ == "__main__":
    class Image2Pixmap(QubPlugPixmapManager2Pixmap) :
