...
cmd = " ".join([config.sip_bin, "-c", '.', "-b", build_file, "-I", config.pyqt_sip_dir,"-I",OpencvInclude, qt_sip_flags,"QubOpenCv.sip"])
print cmd
os.system(cmd)
...
installs.append(["QubOpenCv.sip", os.path.join(config.default_sip_dir, "QubOpenCv")])

installs.append(["QubOpenCvconfig.py", config.default_mod_dir])
...
content = {
    ...
    # installed.
    "QubOpenCv_sip_dir":    config.default_sip_dir,

    # Publish the set of SIP flags needed by this module.  As these are the
    # same flags needed by the qt module we could leave it out, but this
    # allows us to change the flags at a later date without breaking
    # scripts that import the configuration module.
    "QubOpenCv_sip_flags":  qt_sip_flags
}

# This creates the QubOpenCvconfig.py module from the QubOpenCvconfig.py.in
# template and the dictionary.
sipconfig.create_config_module("QubOpenCvconfig.py", "QubOpenCvconfig.py.in", content)
