...
cmd = " ".join([config.sip_bin,"-g", "-e","-c", '.', "-b", build_file, "-I", config.pyqt_sip_dir, qt_sip_flags,"pixmaptools.sip"])
print cmd
os.system(cmd)
...
for line in bfile :
    if 'sources' in line :
        ...
        line = '%s = pixmaptools_io.cpp pixmaptools_lut.cpp pixmaptools_lut_sse.c%s' % (begin,end)
    whole_line += line
bfile.close()
